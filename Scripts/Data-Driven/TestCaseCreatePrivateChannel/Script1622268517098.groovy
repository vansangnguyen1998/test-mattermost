...
for(def row = 1; row <= findTestData("login-account").getRowNumbers() - 1; row++ ) {
		...
		WebUI.setText(findTestObject('Object Repository/Page_Mattermost/input_All team communication in one place, _dcc84b (3)'), 
		    'vinhphat')
		
		WebUI.setEncryptedText(findTestObject('Object Repository/Page_Mattermost/input_All team communication in one place, _a3edc6 (3)'), 
